...
export default function CustomPaginationActionsTable() {
  ...
  // const arrImpresoras = () => (rowsPerPage > 0 ? rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : rows);
  ...
  const filterSelects = () => {
    ...
    // console.log('arrAlmacen ' + arrFilteredAlmacen.length);
    // console.log('arrTipo ' + arrFilteredTipo.length);
    // finalArr = arrFilteredAlmacen.concat(arrFilteredTipo);
